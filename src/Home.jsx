...
const FAQ = () => {
  return (
    <div className="bg-gray-100 py-6 md:py-12 lg:py-24 px-[7vw] md:px-[8vw]">
...
const Home = () => {
  ...
  return (
    <>
      <div className="bg-gray-100 min-h-screen flex flex-col items-center justify-center pt-10">
        <div className="w-full flex flex-col items-center justify-center text-center pt-10 md:pt-20">
          <h1 className="w-3/5 md:w-full text-4xl md:text-5xl font-bold text-gray-800">
            Join the <span className="text-orange-500">solar revolution</span>
          </h1>
          <p className="w-4/5 md:w-full mt-4 text-gray-600">
        ...
        <div className="w-full flex flex-col md:flex-row  justify-arround gap-14 md:gap-2 items-center px-[7vw] lg:px-[10vw]">
          <div className="w-full md:w-1/2 mt-8 grid grid-cols-2 xs:grid-cols-3 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-2">
            {countries.map((country) => (
              <button
                key={country.code}
                className="bg-white p-3 md:p-4 w-[36vw] xs:w-[22vw] md:w-[18vw] lg:w-[12vw] rounded shadow hover:shadow-md transition duration-300 flex items-center justify-start space-x-2"
              >
                <Flag
                  code={country.code}
                  className="w-[6vw] xs:w-[3.7vw] md:w-[3vw] lg:w-[2vw] "
                />
                <span className="text-gray-800 text-[3.5vw] xs:text-[2.2vw] md:text-[1.8vw] lg:text-[1.12vw]">
                  {country.name}
                </span>
              </button>
            ))}
        ...
        <div className="py-12 flex flex-col md:flex-row items-center md:items-start md:justify-between space-y-8 md:space-y-0 md:space-x-8 w-full px-[7vw] lg:px-[10vw]">
          <div className="relative rounded-lg shadow-lg md:max-w-md w-full h-[88vw] xs:h-[60vw] md:h-[38vw] lg:h-[30vw] object-cover ">
            ...
            />
            <div className="absolute bottom-0 p-[2vw] mt-4 z-[20] bg-black/40 text-white rounded-b-lg">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg md:max-w-lg w-full h-[88vw] xs:h-[60vw] md:h-[38vw] lg:h-[30vw] text-[2.85vw] xs:text-[2.25vw] md:text-[1.28vw] lg:text-[1.1vw]">
            <h2 className="text-[4.25vw] xs:text-[3.4vw] md:text-[2.8vw] lg:text-[2vw] font-bold text-gray-800">
              About us
            </h2>
            <p className="mt-[1vw] text-gray-600">
              To homeowners, Otovo is the easiest way to get solar panels on the
              roof and batteries in the home.
            </p>
            <p className="mt-[0.5vw] text-gray-600">
